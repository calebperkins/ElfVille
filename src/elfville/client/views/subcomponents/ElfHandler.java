...
/**
 * The action listener that requests an elf's profile and displays it when a
 * client clicks on a button linking to that elf.
 * 
 */
public class ElfHandler implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		new ElfProfile(board.getClientWindow(), board.getSocketController(),
				elfModelID);
	}
